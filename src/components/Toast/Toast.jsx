...
export function Toast(props) {
  const { dataMensaje, setDataMesaje, tipo, setTipo } = props;
  // console.log(dataMensaje);

  // Verificar si hay un mensaje y el tipo de Toast no es 0
  if (dataMensaje && tipo !== 0) {
    // Establecer un temporizador para ocultar el Toast después de 7 segundos
    setTimeout(function () {
      setDataMesaje("");
      setTipo(0);
    }, 7000);
    ...
    <div className="absolute mt-4 ml-4">
      ...
      {tipo === 1 ? (
        ...
        >
          ...
          <div className="ml-3 text-sm font-normal">{dataMensaje}</div>
